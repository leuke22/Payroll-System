...
public class AdminDashBoard extends JFrame { 
 ...
 private B_AttendanceAdminPage panelAttendance;
 private C_EmployeePage panelEmployee;
 private D_PayrollPage panelPayroll;
 private E_PayslipPage panelPayslip;
 private F_EmployeeId panelID;
  ...
  */ 
 	 ...
 	 public AdminDashBoard(String name, String position) {
 		initialize();
	 ...
	 public void initialize() { 
	  ...
	  panelsPayslip.setBounds(10, 291, 380, 60);
	  ...
	  JPanel panelsEmployeeId = new JPanel();
	  panelsEmployeeId.addMouseListener(new PanelButtonMouseAdapter(panelsEmployeeId){
		  public void mouseClicked(MouseEvent e) {
			  menuClicked(panelID);
		  }
	  });
	  panelsEmployeeId.setLayout(null);
	  panelsEmployeeId.setBorder(new LineBorder(new Color(0, 0, 0), 0));
	  panelsEmployeeId.setBackground(new Color(51, 51, 51));
	  panelsEmployeeId.setBounds(10, 362, 380, 60);
	  paneldash.add(panelsEmployeeId);
	  
	  JLabel lblNewLabel_1_1_1_1_1_1_2 = new JLabel("Employee ID");
	  lblNewLabel_1_1_1_1_1_1_2.setHorizontalAlignment(SwingConstants.LEFT);
	  lblNewLabel_1_1_1_1_1_1_2.setForeground(Color.WHITE);
	  lblNewLabel_1_1_1_1_1_1_2.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 40));
	  lblNewLabel_1_1_1_1_1_1_2.setBackground(Color.WHITE);
	  lblNewLabel_1_1_1_1_1_1_2.setBounds(102, 0, 245, 60);
	  panelsEmployeeId.add(lblNewLabel_1_1_1_1_1_1_2);
	  
	  JLabel lblEmployeeId = new JLabel("");
	  lblEmployeeId.setIcon(new ImageIcon(iconEmployeeId));
	  lblEmployeeId.setHorizontalAlignment(SwingConstants.CENTER);
	  lblEmployeeId.setBounds(10, 0, 82, 60);
	  panelsEmployeeId.add(lblEmployeeId);
